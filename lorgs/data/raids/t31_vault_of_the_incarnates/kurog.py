...
KUROG.add_cast(spell_id=374022, name="Searing Carnage", duration=3 + 5, color="#bf3030", icon="spell_fire_moltenblood.jpg")
...
KUROG.add_cast(spell_id=372456, name="Absolute Zero", duration=2+6, color="#bf3030", icon="spell_frost_glacier.jpg")
...
KUROG.add_cast(spell_id=374691, name="Seismic Rupture", duration=5, color="#bf3030", icon="spell_nature_earthquake.jpg")
