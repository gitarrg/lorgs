...
DRUID_RESTORATION.add_spell( spell_id=740,    cooldown=120, duration=6,  color="#6cbfd9", name="Tranquility",                    icon="spell_nature_tranquility.jpg")
DRUID_RESTORATION.add_buff(  spell_id=117679, cooldown=0,   duration=9,                   name="Incarnation: Tree of Life",      icon="ability_druid_improvedtreeform.jpg", wowhead_data="spell=33891")
