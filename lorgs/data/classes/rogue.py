...
ROGUE_SUBTLETY.add_spell(      spell_id=280719, cooldown=60,               color="#3638d6", name="Secret Technique",    icon="ability_rogue_sinistercalling.jpg")
...
ROGUE_SUBTLETY.add_spell(      spell_id=385408, cooldown=90,               color=COL_NF,    name="Sepsis",              icon="ability_ardenweald_rogue.jpg",             show=False)
...
ROGUE_OUTLAW.add_spell(        spell_id=343142, cooldown=120, duration=8,                   name="Dreadblades",         icon="inv_sword_1h_artifactskywall_d_01dual.jpg")
ROGUE_OUTLAW.add_spell(        spell_id=381989, cooldown=420, duration=30,                  name="Keep It Rolling",     icon="ability_rogue_keepitrolling.jpg")
